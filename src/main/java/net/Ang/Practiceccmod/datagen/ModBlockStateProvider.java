...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        simpleBlockWithItem(ModBlocks.FOSSIL_GRINDER.get(),
                new ModelFile.UncheckedModelFile(modLoc("blocks/fossil_grinder")));
        simpleBlockWithItem(ModBlocks.CLEANING_STATION.get(),
                new ModelFile.UncheckedModelFile(modLoc("blocks/cleaning_station")));
